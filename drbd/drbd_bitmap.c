...
void check_and_clear_io_error_in_primary(struct drbd_device *device)
{
	...
	if (!get_ldev_if_state(device, D_NEGOTIATING))
		return;
	/* DW-1843
	 * MDF_PEER_PRIMARY_IO_ERROR is a value required to prevent removal of the inconsistent OOS generated by io-error 
	 ...
	 */
	if (!drbd_md_test_flag(device, MDF_IO_ERROR))
		return;
