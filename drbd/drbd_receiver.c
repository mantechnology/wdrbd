...
#ifdef _WIN32
	// MODIFIED_BY_MANTECH DW-1076: retrying connection doesn't make sense while receiver's restarting, returning false lets drbd re-enters connection once receiver goes running.
