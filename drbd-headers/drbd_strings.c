...
static const char * const __error_messages[] = {
	...
	[-SS_SECONDARY_FAILED] = "Failed to set secondary role due to barrier ack pending timeout(10s). Wait until resync starts or disconnect first to demote forcibly.",
