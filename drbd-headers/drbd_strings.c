...
static const char * const __error_messages[] = {
	...
	[-SS_SECONDARY_FAILED] = "Failed to set secondary role due to barrier ack pending timeout(10s). After disconnect, commands are possible. But data that is not sent or received in the current buffer can be lost.",
