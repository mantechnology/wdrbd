...
static const char *error_messages[] = {
	...
	EM(ERR_CONG_SNDBUF_SIZE) = "sndbuf-size must be at least 1M to use send buffer\n",
	EM(ERR_CONG_CANT_CHANGE_SNDBUF_SIZE) = "sndbuf-size cannot be dynamically configured\n",
};
