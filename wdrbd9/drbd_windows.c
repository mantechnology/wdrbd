...
extern SIMULATION_DISK_IO_ERROR SimulDiskIoError = {0,};
...
int generic_make_request(struct bio *bio)
{
	...
	//
	//	disk-io error point . (return fail) - disk error simluation type 0
	//
	if(SimulDiskIoError.bDiskErrorOn && SimulDiskIoError.ErrorType == SIMUL_DISK_IO_ERROR_TYPE0) {
